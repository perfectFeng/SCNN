...
for p, d, files in os.walk('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/32'):
    txts = files
    break
for file in txts:
    event = []
    f = open('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/32/' + file, 'r')
    lines = list(f)
    f.close()
    for l in lines:
        v = l.strip('\n').split(' ')[0]
        ...
        if label is L and p>P:
            event.append(l)
    f = open('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/'+t+'/32/'+v.split('.')[0]+'.txt', 'w')
    for e in event:
        f.write(e)
    f.close()
# 64
...
for p, d, files in os.walk('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/64'):
    txts = files
    break
for file in txts:
    event = []
    f = open('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/64/' + file, 'r')
    lines = list(f)
    f.close()
    for l in lines:
        v = l.strip('\n').split(' ')[0]
        ...
        if label is L and p>P:
            event.append(l)
    f = open('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/'+t+'/64/'+v.split('.')[0]+'.txt', 'w')
    for e in event:
        f.write(e)
    f.close()
...
for p, d, files in os.walk('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/'+t+'/32'):
    txts = files
    break
for file in txts:
    flag = 0
    event = []
    f = open('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/'+t+'/32/' + file, 'r')
    lines = list(f)
    f.close()
    if len(lines) == 0:
        continue
    ...
    for l in lines:
        ...
        if flag:
            event.append(l)
    f = open('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/'+t+'/32/'+file, 'w')
    for e in event:
        f.write(e)
    f.close()
...
for p, d, files in os.walk('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/'+t+'/64'):
    txts = files
    break
for file in txts:
    flag = 0
    event = []
    f = open('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/'+t+'/64/' + file, 'r')
    lines = list(f)
    f.close()
    if len(lines) == 0:
        continue
    ...
    for l in lines:
        ...
        if flag:
            event.append(l)
    f = open('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/'+t+'/64/'+file, 'w')
    for e in event:
        f.write(e)
    f.close()
...
for i in range(len(dir_64)):
    ...
    file_32 = dir_32[i]
    file_64 = dir_64[i]
    f_32 = open('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/'+t+'/32/' + file_32, 'r')
    f_64 = open('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/'+t+'/64/' + file_64, 'r')
    l_32 = list(f_32)
    l_64 = list(f_64)
    f_32.close()
    f_64.close()
    ...
    f = open('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/final_result/'+t+'/'+file_32, 'w')
    for e in event:
        f.write(e)
...
for p, d, files in os.walk('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/final_result/' + t):
    file = files
    break
for name in file:
    f = open('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/final_result/final_result/'+t+'/' + name)
...
file = []
for p, d, files in os.walk('D:/冯咩咩的文件夹/soccer_detection/SCNN/localization/prepredict/original_result/32/'):
    file = files
    break
for name in file:

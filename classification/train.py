...
model_filename = "./chckPts/sports1m_finetuning_ucf101.model"
start_step = 0
...
with tf.device('/gpu:1'):
    with tf.Graph().as_default():
        ...
        train_op1 = tf.train.GradientDescentOptimizer(1e-3).minimize(loss, var_list=var2)
        train_op2 = tf.train.GradientDescentOptimizer(1e-2).minimize(loss, var_list=var1)
